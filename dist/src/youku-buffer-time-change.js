...
(function() {
   ...
   */    var hasRequiredReactDom_production_min;
    ...
    function getLastVideoBufferInfo() {
        ...
        return (_h = (_g = (_f = (_e = (_d = (_c = (_b = (_a = videoPlayer.context) === null || _a === void 0 ? void 0 : _a.core) === null || _b === void 0 ? void 0 : _b._proxy) === null || _c === void 0 ? void 0 : _c.player) === null || _d === void 0 ? void 0 : _d.mediaEngine) === null || _e === void 0 ? void 0 : _e.lastBufferInfo) === null || _f === void 0 ? void 0 : _f.video) === null || _g === void 0 ? void 0 : _g.bufferLength) !== null && _h !== void 0 ? _h : -1;
    }
    function updateBufferLength(newBufferLength) {
        var _a, _b, _c, _d, _e, _f;
        var timelineList = unsafeWindow.videoPlayer;
        (_f = (_e = (_d = (_c = (_b = (_a = timelineList.context) === null || _a === void 0 ? void 0 : _a.core) === null || _b === void 0 ? void 0 : _b._proxy) === null || _c === void 0 ? void 0 : _c.player) === null || _d === void 0 ? void 0 : _d.mainController) === null || _e === void 0 ? void 0 : _e.timelineList) === null || _f === void 0 ? void 0 : _f.forEach((function(item) {
            if ((item === null || item === void 0 ? void 0 : item.config) && Object.keys(item.config).length > 0) {
        ...
        reactExports.useEffect((function() {
            var checkAndSetOnPlaying = function checkAndSetOnPlaying() {
                ...
                if (videoPlayer && videoPlayer._player && typeof videoPlayer._player.onPlaying !== "undefined") {
                    var originalOnPlaying = videoPlayer._player.onPlaying;
                    var enhancedOnPlaying = function enhancedOnPlaying() {
            ...
            var checkInterval = setInterval(checkAndSetOnPlaying, 3e3);
            var triggerInterval = setInterval(triggerPlaying, 3e3);
            return function() {
                clearInterval(checkInterval);
        ...
        reactExports.useEffect((function() {
            function triggerKeyFunc(event) {
                if (event.key.toLocaleLowerCase() === triggerKey.toLocaleLowerCase()) {
                    var bufferLength = getLastVideoBufferInfo();
                    alert("Now BufferLength : ".concat(bufferLength));
                }
            }
