...
(function() {
    ...
    var App = function App() {
        var _useGmValue = useGmValue("triggerKey", "h"), triggerKey = _useGmValue.data, updateTriggerKey = _useGmValue.updateData;
        ...
        reactExports.useEffect((function() {
            function playerSeek(event) {
                if (event.key.toLocaleLowerCase() === triggerKey) {
                    var videoElement = document.querySelector("#movie_player > div.html5-video-container > video");
