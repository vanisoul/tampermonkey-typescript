...
(function() {
    ...
    const toDisplayString = val => isString(val) ? val : val == null ? "" : isArray$1(val) || isObject$1(val) && (val.toString === objectToString$1 || !isFunction$1(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
    ...
    const normalizeRef = ({ref: ref, ref_key: ref_key, ref_for: ref_for}) => ref != null ? isString(ref) || isRef(ref) || isFunction$1(ref) ? {
    ...
    /*! Element Plus Icons Vue v2.3.1 */    var close_vue_vue_type_script_setup_true_lang_default = defineComponent({
        name: "Close",
        __name: "close",
        setup(__props) {
    ...
    var Icon = _export_sfc(_sfc_main$7, [ [ "__file", "icon.vue" ] ]);
    ...
    var ElFocusTrap = _export_sfc(_sfc_main$6, [ [ "render", _sfc_render ], [ "__file", "focus-trap.vue" ] ]);
    ...
    var Button = _export_sfc(_sfc_main$5, [ [ "__file", "button.vue" ] ]);
    ...
    var ButtonGroup = _export_sfc(_sfc_main$4, [ [ "__file", "button-group.vue" ] ]);
    ...
    const _sfc_main$3 = defineComponent({
        ...
        setup(__props) {
            ...
            return (_ctx, _cache) => (openBlock(), createBlock(resolveDynamicComponent(_ctx.tag), {
    ...
    var Row = _export_sfc(_sfc_main$3, [ [ "__file", "row.vue" ] ]);
    ...
    const _sfc_main$2 = defineComponent({
        ...
        setup(__props) {
            const props = __props;
            const {gutter: gutter} = inject(rowContextKey, {
                gutter: computed((() => 0))
            });
    ...
    var Col = _export_sfc(_sfc_main$2, [ [ "__file", "col.vue" ] ]);
    ...
    const ButtonDialog = defineComponent({
        ...
        setup(props, {emit: emit}) {
            ...
            return () => {
                let _slot;
                return createVNode("div", null, [ createVNode(ElButton, {
                    onClick: openDialog
                }, {
                    default: () => [ props.buttonLabel ]
                }), showDialog.value && createVNode(ElDialog, {
                    modelValue: showDialog.value,
                    "onUpdate:modelValue": $event => showDialog.value = $event,
                    onClosed: closeDialog
                }, _isSlot$1(_slot = props.renderDialog()) ? _slot : {
                    default: () => [ _slot ]
                }) ]);
            };
        }
    ...
    const SelectOptionComponent = defineComponent({
        ...
        setup(props, {emit: emit}) {
            ...
            return () => {
                let _slot;
                var _a;
                return createVNode("div", null, [ createVNode(ElRow, null, {
                    default: () => [ createVNode(ElCol, null, _isSlot(_slot = props.renderTitle()) ? _slot : {
                        default: () => [ _slot ]
                    }) ]
                }), createVNode(ElRow, null, {
                    default: () => [ (_a = props.options) === null || _a === void 0 ? void 0 : _a.map(((option, idx) => createVNode(ElCol, {
                        key: option
                    }, {
                        default: () => [ createVNode(ElButton, {
                            onClick: () => handleSelectOption(idx, option)
                        }, _isSlot(option) ? option : {
                            default: () => [ option ]
                        }) ]
                    }))) ]
                }) ]);
    ...
    const buttonDialog = createApp({
        setup() {
            ...
            function selectOption(idx, _) {
                return __awaiter(this, void 0, void 0, (function*() {
                    const result = yield gamerAPI.sendAnswer(questionToken.value, idx + 1);
                    if ("error" in result) {
                        questionTitle.value = "";
            ...
            const renderDialog = () => createVNode(SelectOptionComponent, {
                onSelectOption: selectOption,
                renderTitle: () => createVNode(Fragment, null, [ createVNode("b", null, [ createVNode("div", null, [ questionTitle.value ]) ]), createVNode("br", null, null), createVNode("div", null, [ question.value ]), createVNode("br", null, null) ]),
                options: options.value
            }, null);
            const buttonLabel = "動畫瘋答題";
            function updateQuestion() {
                return __awaiter(this, void 0, void 0, (function*() {
                    const result = yield gamerAPI.getQuestion();
                    if ("error" in result) {
                        questionTitle.value = "";
                        question.value = result.msg;
                        options.value = [];
            ...
            return () => createVNode("li", null, [ createVNode(ButtonDialog, {
                class: "flex space-x-1 min-h-screen justify-center items-center",
