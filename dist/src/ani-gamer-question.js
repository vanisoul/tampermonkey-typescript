...
(function () {
    ...
    ***************************************************************************** */
    ...
    var Col = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__file", "col.vue"]]);
    ...
    const buttonDialog = createApp({
      setup() {
        ...
        function selectOption(idx, _) {
          return __awaiter(this, void 0, void 0, function* () {
            const result = yield gamerAPI.sendAnswerByGM(questionToken.value, idx + 1);
            if ('error' in result) {
              questionTitle.value = "";
        ...
        function updateQuestion() {
          return __awaiter(this, void 0, void 0, function* () {
            const result = yield gamerAPI.getQuestionByGM();
            if ('error' in result) {
              questionTitle.value = "";
              question.value = result.msg;
              options.value = [];
