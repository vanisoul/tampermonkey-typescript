...
(function() {
   ...
   */    var hasRequiredReactDom_production_min;
    ...
    var PLAYBACK_SPEEDS = [ .5, .75, 1, 1.25, 1.5 ];
    function NetflixEnhancer() {
        ...
        var applyPlaybackSpeed = reactExports.useCallback((function() {
        ...
        var toggleNextEpisode = reactExports.useCallback((function() {
            updateSettings(_objectSpread2(_objectSpread2({}, settings), {}, {
                nextEpisodeEnabled: !settings.nextEpisodeEnabled
            }));
        }), [ settings, updateSettings ]);
        var toggleSpeedControl = reactExports.useCallback((function() {
            updateSettings(_objectSpread2(_objectSpread2({}, settings), {}, {
        ...
        var setPlaybackSpeed = reactExports.useCallback((function(speed) {
            updateSettings(_objectSpread2(_objectSpread2({}, settings), {}, {
        ...
        useGmMenu("自動跳過簡介: ".concat(settings.skipIntroEnabled ? "開" : "關"), toggleSkipIntro);
        useGmMenu("自動下一集: ".concat(settings.nextEpisodeEnabled ? "開" : "關"), toggleNextEpisode);
        useGmMenu("播放速度控制: ".concat(settings.speedControlEnabled ? "開" : "關"), toggleSpeedControl);
        PLAYBACK_SPEEDS.forEach((function(speed) {
            var isActive = settings.defaultPlaybackSpeed === speed;
            var speedText = speed === 1 ? "1x (正常)" : "".concat(speed, "x");
            useGmMenu("播放速度: ".concat(speedText).concat(isActive ? " ✓" : ""), (function() {
    ...
    var mountInterval = setInterval((function() {
        var success = appendComponentToElement(NetflixEnhancer, "body");
        if (success) {
